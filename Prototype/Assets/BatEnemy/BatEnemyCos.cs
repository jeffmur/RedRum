...
public class BatEnemyCos : Enemy
{
    ...
    protected override void Move(Vector2 direction)
    {
        ...
        rb.MovePosition((Vector2)transform.position + (direction * speed * Time.smoothDeltaTime) + ((Vector2)transform.up * Mathf.Cos(Time.time * fraquency) * magnitude));
